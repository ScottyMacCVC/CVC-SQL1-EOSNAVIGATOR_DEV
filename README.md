...
We also seek to explore the effects of Covid on  labor productivity. The cost of construction and ultimately the house itself, has risen during Covid wiht many families concerned over price and employees for their helath. The question is, "has the labor productivity rates changed?" We know there is a $/Hr rise, material $/units have been driven up by supply chain issues, but we have no definitive proof of labor rate changes. Our team will analyze the data for labor productivity trends associated with the Covid time frame.
